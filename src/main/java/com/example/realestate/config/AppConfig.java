...
public class AppConfig implements WebMvcConfigurer {
    ...
    @Value("rzp_test_tUkiSupgeAD0RT") // Inject Razorpay key ID from application.properties
    private String razorpayKeyId;

    @Value("kBSFHrpYJ4jFEmJUAbelhCkN") // Inject Razorpay key secret from application.properties
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        .addResourceLocations("file:C:/Users/venka/OneDrive/Desktop/realestatebackent/RealEstate/Backend/uploads/");
